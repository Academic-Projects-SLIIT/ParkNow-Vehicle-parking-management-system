    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/home", "/register", "/login", "/logout", "/slot-map", "/api/slots/map", "/api/home/**",
            ...
            .csrf(csrf -> csrf.ignoringRequestMatchers("/h2-console/**", "/register", "/login", "/logout", "/slot-map", "/api/home/**", "/auth/login",
